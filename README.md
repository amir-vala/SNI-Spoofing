...
2. Run the program using the automated starter script:
   ```bash
   # Windows
   python start.py
   ...
   ```
   The `start.py` script will automatically create a virtual environment, install dependencies, and launch the application.
